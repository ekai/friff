...
(function($) {
    ...
    $('body').videoBG({
        position:"fixed",
		zIndex:0,
		mp4:'video/GGB_video_v2.mp4',
		ogv:'video/GGB_video_v2.ogv',
		webm:'video/GGB_video_v2.webm',
		poster:'video/GGB_video.jpg',
		opacity:1,
		fullscreen:true
	});
    ...
    $('.mailchimp').ajaxChimp({
        ...
        url: "http://flyingrobotfilmfestival.us11.list-manage.com/subscribe/post?u=90b711b3f039e8b688fc17aa5&amp;id=f8e4e7f5f7" //Replace this with your own mailchimp post URL. Don't remove the "". Just paste the url inside "".  
    });
